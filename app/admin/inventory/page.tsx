...
// ─── Shared sub-components (defined OUTSIDE parent) ──────────────────────────
...
const ProductRow = ({
  ...
  return (
    ...
    >
      ...
      <button
        className="flex cursor-pointer items-center justify-center gap-1.5 px-2.5 py-1.5 border border-[#e8e0d5] font-sans text-[10px] font-bold tracking-widest uppercase text-[#7a7068] hover:border-[#b8945e] hover:text-[#b8945e] transition-all duration-150"
      ...
      <button
        ...
        className="flex cursor-pointer items-center gap-1.5 px-2.5 py-1.5 border font-sans text-[9px] font-bold tracking-widest uppercase transition-all duration-150 whitespace-nowrap"
        style={{
      ...
      <button
        className="flex cursor-pointer items-center justify-center p-1.5 border border-[#e8e0d5] text-[#7a7068] hover:border-[#c0392b] hover:text-[#c0392b] hover:bg-[rgba(192,57,43,0.08)] transition-all duration-150"
        onClick={() =>
          setConfirmDialog({
            type: "delete",
            productId: product._id!,
    ...
    <div className="font-serif bg-[#f7f3ee] min-h-screen text-[#1c1813]">
      ...
      {confirmDialog && (
        <div className="fixed inset-0 z-[1000] bg-black/40 flex items-center justify-center p-5">
          <div className="bg-white border border-[#e8e0d5] p-7 max-w-[360px] w-full shadow-[0_8px_40px_rgba(0,0,0,0.15)]">
